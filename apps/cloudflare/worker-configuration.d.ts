/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 518f262995d6d75bce7d94d9d0e8fb2b)
...
interface __BaseEnv_Env {
	...
	AUTH_MAIL_FROM: "no-reply@mail.eventforge.dev";
	AUTH_CONSOLE_ORIGIN: "https://eventforge.dev";
	CANARY_WEBHOOK_SECRET: string;
	PAYLOAD_MASTER_KEY: string;
	WAITLIST_RATE_LIMIT_SECRET: string;
	TURNSTILE_SECRET?: string;
	IDENTITY_AUTHORITY: DurableObjectNamespace<import("./src/index").SessionAuthority>;
	AUTH_CAPTCHA_DISABLED?: "true";
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SessionAuthority";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "PUBLIC_INGRESS_ENABLED" | "DURABLE_DELIVERY_ENABLED" | "MONITORING_ENABLED" | "CANARY_WORKSPACE_ID" | "CANARY_PROJECT_ID" | "CANARY_ENVIRONMENT_ID" | "AUTH_MAIL_FROM" | "AUTH_CONSOLE_ORIGIN" | "CANARY_WEBHOOK_SECRET" | "PAYLOAD_MASTER_KEY" | "WAITLIST_RATE_LIMIT_SECRET" | "TURNSTILE_SECRET" | "AUTH_CAPTCHA_DISABLED">> {}
}
