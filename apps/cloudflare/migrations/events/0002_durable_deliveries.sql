create table if not exists deliveries (
  ...
  safe_reason text check (safe_reason in ('timeout','validation_error','upstream_unavailable','rate_limited','payload_unavailable','payload_corrupt','payload_too_large','workspace_suspended','workspace_deleted','retry_exhausted','reconciliation','internal_error')),
...
create table if not exists delivery_dlq (
  ...
  workspace_id text not null,
  safe_reason text not null check (safe_reason in ('timeout','validation_error','upstream_unavailable','rate_limited','payload_unavailable','payload_corrupt','payload_too_large','workspace_suspended','workspace_deleted','retry_exhausted','reconciliation','internal_error')),
  correlation_id text not null,
