      ...
      <section className="ef-hero">
        <div className="ef-hero-copy">
          <div className="ef-eyebrow">
            <Asterisk size={14} /> Your event layer for agent-ready work
          </div>
          <h1>
            One place for
            <br />
          ...
          <p className="ef-hero-intro">
            EventForge centralizes the signals from the tools your team already uses, filters out
            the chatter, and turns the important events into useful work.
          </p>
          <div className="ef-hero-actions">
            <a className="ef-primary-cta" href="/console">
              See your event inbox <ArrowDownRight size={18} />
            </a>
            <a
          ...
          <div className="ef-hero-footnote">
            <span className="ef-live-dot" /> Keep your current stack. Give its signals one useful
            place to go.
          </div>
        </div>
        <TraceBoard />
